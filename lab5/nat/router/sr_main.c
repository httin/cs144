...
int main(int argc, char **argv)
{
    ...
    sr.nat_mode = false;
    sr.icmp_query_timeout = DEFAULT_ICMP_TIMEOUT;
    sr.tcp_established_timeout = DEFAULT_TCP_ESTABLISHED_TIMEOUT;
    sr.tcp_transitory_timeout = DEFAULT_TCP_TRANSITORY_TIMEOUT;
    ...
    while ((c = getopt(argc, argv, "hns:v:p:u:t:r:l:T:I:E:R:")) != EOF)
    {
        switch (c)
        {
            ...
            case 'n':
                ...
                break;
            case 'I':
                sr.icmp_query_timeout = atoi((char *) optarg);
                break;
            case 'E':
                sr.tcp_established_timeout = atoi((char *) optarg);
                break;
            case 'R':
                sr.tcp_transitory_timeout = atoi((char *) optarg);
                break;
        } /* switch */  
    } /* -- while -- */
